...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FedRegDoc.xml_full_text'
        db.add_column('fedregfeed_fedregdoc', 'xml_full_text', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FedRegDoc.xml_full_text'
        db.delete_column('fedregfeed_fedregdoc', 'xml_full_text')
