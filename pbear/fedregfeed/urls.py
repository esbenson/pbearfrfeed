...
urlpatterns = patterns('fedregfeed.views',
    ...
    url(r'^list/$', 'multiple', {'display_num':display_num, 'update_database_flag':True}, name='pbear_list_default'), # calls the update/display view with default args
    url(r'^$', 'multiple', {'display_num':display_num, 'update_database_flag':True}, name='pbear_list_default'), # calls the update/display view with default arguments - (no pk) and num to display and update_database_flag=True
